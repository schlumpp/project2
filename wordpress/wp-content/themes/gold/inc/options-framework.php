...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Gold Theme Options', 'optionsframework'),
		'menu_title' => __('Gold Theme Options', 'optionsframework'),
...
function optionsframework_page() {
	...
	<div id="header">
		...
		<div class="theme-option-link"><h4>For Support Click <a href="http://code-b.in/wordpress-gold/themes/gold/docs/" target="_blank">Here</a></h4></div>			
