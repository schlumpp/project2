...
global $midnightcity_options_db;
	if ($midnightcity_options_db['midnightcity_css'] == 'Blue-Violet (default)' ){
			wp_enqueue_style('midnightcity-style', get_stylesheet_uri());
		}
    
    if ($midnightcity_options_db['midnightcity_css'] == 'Blue-Green' ){
			wp_enqueue_style('style-blue-green', get_template_directory_uri().'/css/blue-green.css');
		}
    
    if ($midnightcity_options_db['midnightcity_css'] == 'Orange-Green' ){
			wp_enqueue_style('style-orange-green', get_template_directory_uri().'/css/orange-green.css');
		}
    
    if ($midnightcity_options_db['midnightcity_css'] == 'Red-Blue' ){
			wp_enqueue_style('style-red-blue', get_template_directory_uri().'/css/red-blue.css');
		}
}
