...
<?php if ( is_tax('videos') ) {?><title><?php wp_title('');?> - <?php bloginfo('name'); ?></title><?php }?>
...
<?php } ?>
<?php if ( is_category() || is_tax('videos')) { ?>
...
<meta name="description" content="<?php echo get_option('qqoq_description'); ?>" />
<meta name="keywords" content="<?php echo get_option('qqoq_keywords'); ?>" />
<?php } ?>