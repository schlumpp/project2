...
<?php get_header( ); ?>
	<div id="container" class="">
		<div id="content" class="container_12 grid_10 push_5">
			<h1 class="page-title">
			<?php if ( is_day() ) : ?>
							<?php printf( __( 'Daily Archives: <span>%s</span>', 'codium_grid' ), get_the_date() ); ?>
			<?php elseif ( is_month() ) : ?>
							<?php printf( __( 'Monthly Archives: <span>%s</span>', 'codium_grid' ), get_the_date('F Y') ); ?>
			<?php elseif ( is_year() ) : ?>
							<?php printf( __( 'Yearly Archives: <span>%s</span>', 'codium_grid' ), get_the_date('Y') ); ?>
			<?php else : ?>
							<?php _e( 'Blog Archives', 'codium_grid' ); ?>
			<?php endif; ?>
			</h1>
