...
<div>
<div id = "contest1"><a href="subject_contest.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('subject','','images/activity/subject_blue.png',1)"><img class = "subject_contest" src="images/activity/subject_grey.png" id="subject" /></a></div>
<div id = "contest2"><a href="class_test.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('test','','images/activity/test_blue.png',1)"><img class = "class_test" src="images/activity/test_grey.png" id="test" /></a></div>
</div>
<div id = "main">
<table>
<thead>
