...
<div>
<div id = "class1"><a href="common_class.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('class_ch1','','images/class/common_class_blue.png',1)"><img class = "class1" src="images/class/commom_class.png" width="371" height="67" id="class_ch1" /></a></div>
<div id = "class2"><a href="restart_study.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('class_ch2','','images/class/restart_study_blue.png',1)"><img class = "class2" src="images/class/restart_study.png" width="336" height="67" id="class_ch2" /></a></div>
<div id = "class3"><a href="pre_class.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('class_ch3','','images/class/pre_class_blue.png',1)"><img class = "class3" src="images/class/pre_class.png" width="378" height="67" id="class_ch3" /></a></div>
</div>
