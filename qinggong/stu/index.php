   ...
   <!--                  </marquee>-->
            	...
            	<div class="search">         
            		<div class="connectUs">
                        ...
                        <img src="img/connectUs_bgd.png" class="devive">
                         ...
                         <tr>
                            <td>邮&nbsp;&nbsp;箱：</td>
                            <td colspan="4">shenjixijun@163.com</td>
                         </tr>
                         <tr>
                            <td>QQ&nbsp;&nbsp;群：</td>
                            <td colspan="4">296657843</td>
                         </tr>
                         <tr>
                            <td>地&nbsp;&nbsp;址：</td>
                            <td colspan="4">杭州市江干区学林街16号</td>
                         </tr>
                       </table>            	
                  </div>
           		</div>
           ...
           <div class="left">
           	<div class="latestNews_title">
           		<ul>
            		<li class="latestNews_title_f1"></li>
                	<li class="latestNews_title_f2">岗位招聘信息</li>
					  ...
					  if(($num = mysql_num_rows($result)) != null)//取出的记录不为空
						{  
							for( $shu=0 ;$shu<6;$shu++)
								...
								print mb_substr($row['work_name'],0,10,'utf-8')."......";//($row['work_name'],10);
							    //print $row['work_name']."";							
             ...
             <!--左半部分结束-->
              <!--右半部分开始-->
           	...
           	<div class="latestNews_title">
           		<ul>
            		<li class="latestNews_title_f1">&nbsp;&nbsp;</li>
                	<li class="latestNews_title_f2">岗位招聘结果</li>
                	<li class="latestNews_title_f3"><a  href="#"> >>MORE </a></li>
            	</ul>
             </div>
             <div class="latestNews_content">           
             	<ul>
