...
$(function(){
	$('#more').more({'address': 'php/recommend/movies.php'});
});
</script>
<style>
        ...
        <div class="content">
        	<div class="content_resize">
        		...
        		<div class="right_content">
                	<div class="position">
                     	<a href="main.php"><img class="fl" src="img/home.png"></a><span><p class="position_now">当前位置: > <a href="main.php">首页 </a>> <a href="recomMovies.php">励志部落</a> ><a href="recomMovies.php">励志电影推荐</a></p></span>
                   	</div>	
                    <div class="detail_latestNews_title">
           		<ul>
            		<li class="detail_latestNews_title_f1"></li>
                	<li class="detail_latestNews_title_f2">电影推荐</li>
            	</ul>
             </div>
