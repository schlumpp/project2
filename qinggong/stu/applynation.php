        ...
        <div class="content">
        	<div class="content_resize">
                            ...
                            <form >
                     			<table  width="100%">
                                    ...
                                    <!--    <td><input type = 'text' name='household' disabled="disabled"  <?php  if( $row['aidSch_household']=="1")
                                         ...
                                         <td><input type = 'text' name='household' disabled="disabled"  
										 <?php 
										  if( $row['aidSch_household']=="1")
										     echo "value='城镇'" ; else if($row['aidSch_household']=="2") echo"value='农村'"; ?>></td>
				 ...
				 <div class="mess">
                        ...
                        <div class="mess_detial" >
                            <form action="deal_nation.php"  class="form4"  method="post">
                     			               <p>申请理由：</p>        
                                    		  <textarea  cols="40" rows="10" name="text"  class="input required"></textarea>             
