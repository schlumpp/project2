...
/*if(!isset($_SESSION["managename"]))
 ...
 {*/
	 ...
	 print("<tr class='f_tr'>");
	 print("<td width='50px;'><h3>编名   </h3></td>");
...
/*		if($num%2==1)
           print("<tr style='background-color:#057eef'>");
		else
		   print("<tr style='background-color:#fff'>");*/
	    $num=$num+1;
		 print("<td>".$num."</td><td><center>".$row['news_title']."</a></center></td><td>".$row['news_time']."</td>");	
		 print("<td>"."<a href=\"javascript:if(confirm('是否要修改？')) window.location='edit_news.php?sid=".$row['id']."';\"><img src='img/edit.gif' border='0'/>"."</td>");	
		 print("<td>"."<a href=\"javascript:if(confirm('是否要删除？')) window.location='delete_news.php?sid=".$row['id']."';\"><img src='img/delete.gif' border='0'/>"."</td>");
		 print("<td>"."<a href='readnews.php?id=".$row["id"]."'target'='_blank'><img src='img/view.gif' border='0'/>"."</td>");	 
		   print("</tr>");
