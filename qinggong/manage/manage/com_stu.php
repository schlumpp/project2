...
<?php 
					...
					$sql = "select * from applyfor left join student on student.stu_id=applyfor.apply_id  where applyfor.apply_type=1   and applyfor.applySch_state=1  and applyfor.applyfor_year=  '".$year."' ";
					$rs=mysql_query($sql);
  ...
  <div id="widget table-widget">
	...
	<?php	
		...
		?>
					  ...
					  <tr class=" ">
						<td colspan="7" class="checkBox"><?php      echo '<br/><br/>'.$page_string;  ?>　</td>
					  </tr>
