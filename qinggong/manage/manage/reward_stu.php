...
/*if(!isset($_SESSION["managename"]))
 ...
 {*/
 $year=date('Y');
	  $sql="select * from student,applyfor,national_scholarship where student.stu_id=apply_id and applySch_state=2 and type=2 and nationalSch_year='".$year."' and national_scholarship.stu_id=apply_id and apply_type=2 limit $offset,$Page_size"; 
      $rs=mysql_query($sql);
	  ?>
 <table   width='70%'> 
 <tr class="f_tr">
