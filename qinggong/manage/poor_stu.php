...
<?php 
					...
					$sql = "select count(*) as amount  from student  where   type=2";
				//	print $sql;
					$rs=mysql_query($sql);
  ...
  <div id="widget table-widget">
	...
	<?php	
		              if($amount )
                        ...
                        $query=mysql_query("select * from student  where   type=2  order by  stu_id  limit ". ($page-1)*$page_size .", $page_size");
