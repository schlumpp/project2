...
<?php
					...
					include("config.php");
					include("conn.php");
					$sql = "select count(*) as amount from recom_infos ";
      ...
      <table>
		...
		<?php	
		              if($amount )
                        ...
                        $query=mysql_query("select * from recom_infos  order by recom_id  desc limit ". ($page-1)*$page_size .", $page_size");
						...
						$num++;
						 ...
						 print("<td>".$num."</td>");
						 print("<td>".$tyep."</td>");
						 print("<td>".$row['recom_name']."</td>");
						 print("<td>".$row['da_time']."</td>");
						 print("<td>".$row['da_num']."</td>");						 
						 print("<td><a href=\"javascript:if(confirm('是否要删除？')) window.location='delete_recommend.php?sid=".$row['recom_id']."';\"><img src='img/delete.gif' border='0' /></a>
									 </td>");						 
        				 print(" </tr>");					 	
                        }
                    }
